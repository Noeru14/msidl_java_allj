...
public class ThermometerInterneUI extends JFrame implements ChangeListener{
	...
	private ThermometreInterne thermometre;
	
	public ThermometerInterneUI(ThermometreInterne thermometre){
	this.thermometre=thermometre;
	this.setSize(500, 280);
	this.setTitle("Gestionnaire Thermometre Interne");
	...
	container.setBackground(Color.white);
	 ...
	 jlblHeader= new JLabel("<html><u>Gestionnaire Thermometre Interne<u></html>");
	 jlblHeader.setBounds(10, 10, 300, 20);
	 container.add(jlblHeader);
	 
	 jlblSetTemp= new JLabel("<html>Veuillez choisir la temperature interieure</html>");
	...
	void refreshLabel(){
		jlblGetTemp.setText("<html>La temperature interieure est de : "+slider.getValue()+" °C</html>");
		if(slider.getValue()<10){
			jlblGetTemp.setIcon(new ImageIcon(getClass().getResource("/resources/cold-int.png")));
		}else if (slider.getValue()>25){
			jlblGetTemp.setIcon(new ImageIcon(getClass().getResource("/resources/hot-int.png")));
		}else{
			jlblGetTemp.setIcon(new ImageIcon(getClass().getResource("/resources/ok-int.png")));
		}
	}
